...
/* 
The UGV logs a message of a “Soak” with the following information:
i. RTXDC_2024
...
void init_Adafruit_GPS() {
  ...
  // Attach an interrupt to the PPS pin. The interrupt is called on the rising edge.
  attachInterrupt(digitalPinToInterrupt(ppsPin), ppsPulse, RISING);
